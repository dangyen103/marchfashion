            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="body-mail">
                        ...
                        <p>Chúng tôi rất lấy làm tiếc khi phải thông báo đơn hàng <span style="color: #ff7300;">#{{ str_pad($order->id, 8, '0', STR_PAD_LEFT) }}</span> của bạn đã bị hủy.  
                            Nhân viên của chúng tôi đã liên lạc với bạn và trao đổi về điều này.</p>

                        <p>Mọi đóng góp, phản ánh về dịch dụ và chất lượng sản phẩm, xin vui lòng liên hệ:</p>
                        <ul>
                            <li>Hotline: <strong>(+84) 6686 8080</strong></li>
                            <li>Email: <strong>contact.marchfashion@gmail.com</strong></li>
                        </ul>

                        <p style="margin-top: 20px;">Cảm ơn bạn đã sử dụng dịch vụ mua hàng trực tuyến tại March Fashion.</p>
