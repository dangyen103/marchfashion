            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="body-mail">
                        ...
                        <p>Đơn hàng <span style="color: #ff7300;">#{{ str_pad($order->id, 8, '0', STR_PAD_LEFT) }}</span> của bạn đã được giao thành công. 
                            March Fashion hi vọng bạn hài lòng với các sản phẩm của chúng tôi.</p>

                        <p style="margin-top: 20px;">Một lần nữa xin cảm ơn bạn đã sử dụng dịch vụ mua hàng trực tuyến tại March Fashion.</p>
