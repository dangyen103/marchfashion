            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="body-mail">
                        ...
                        <p>Đơn hàng <span style="color: #ff7300;">#{{ str_pad($order->id, 8, '0', STR_PAD_LEFT) }}</span> của bạn đã được xác nhận và đang được nhân viên của chúng tôi đóng gói.  
                            Chúng tôi sẽ tiếp tục thông tin đến bạn về trạng thái tiếp theo của đơn hàng.</p>
